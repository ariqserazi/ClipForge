(function () {
  ...
  var DEFAULT_SETTINGS = {
    inputFolder: "/Users/ariqserazi/3GLore/top10Romance2026/10",
    outputFolder: "/Users/ariqserazi/3GLore/top10Romance2026/10/clips",
    clipCount: 30,
    clipLength: 6,
    skipFirstSeconds: 90,
    skipLastSeconds: 90,
  ...
  var TOOL_HINT = "Install ffmpeg with Homebrew:\nbrew install ffmpeg"
  ...
  function buildToolEnv() {
    ...
    var preferredPath = ["/opt/homebrew/bin", "/usr/local/bin", currentPath]
      .filter(Boolean)
      .join(":")
